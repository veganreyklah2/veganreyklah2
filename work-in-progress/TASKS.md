...
- [x] **NS-L3 lap 3w-4 hosted batch wire** — `recall_batch_wire.rye` + `recall_batch_delivery.rye`; ports **38480/38481**; `bead-index` in `known_tilaks`; `tools/mantra_recall_batch_wire.rish`; parity **166**
- [ ] **NS-L3 batch wire device** — virtio guests; ports **15563/15564**; multi-frame batch chunking for large bolts
