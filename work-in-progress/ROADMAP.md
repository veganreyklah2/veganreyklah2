...
**Last updated:** 2026-07-09 (MALA M1 lap-open `182354`; M0 gate verified; parity **197**)
...
| **MALA M1** | One issuer, one holder — mint, send, receipt, balance-as-fold on one node; lap-open [`182354`](../expanding-prompts/20260709-182354_mala-m1-one-issuer-one-holder.md); M0 gate verified; waits Kaeden | design [`031312`](../active-designing/20260702-031312_modules-aspects-and-mailable-money.md) |
