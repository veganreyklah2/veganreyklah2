...
1. **TAME hardening** — **TH-0–TH-2b done**; **TH-2c** bare assert on remaining hosted modules, then flip `tame-check` to gate; **TH-3** mantra width migration (strategy pause); TH-4–TH-5; RS-1–RS-3 beside it in Rishi.
