...
1. **TAME hardening** — **TH-0 done** (TAME Guidance rename); **TH-1 done** (width-check seam-aware); **TH-2 done** (tame-check informational); **TH-2b** Mantra assert compliance keystone, then TH-3–TH-5; RS-1–RS-3 beside it in Rishi.
