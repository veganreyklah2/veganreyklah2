...
**Docs compression layer — design seated `221600` · PROVEN_SEAT landed:** five-page layout at [`../active-designing/20260712-221600_docs-compression-layer-design.md`](../active-designing/20260712-221600_docs-compression-layer-design.md). First page [`../docs/PROVEN_SEAT.md`](../docs/PROVEN_SEAT.md) compresses ~10 proven-seat notes. Next: ENCLOSURE · lint name.
