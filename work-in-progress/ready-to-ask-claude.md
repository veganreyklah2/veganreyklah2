...
**Docs compression layer — design seated `221600`:** five-page layout at [`../active-designing/20260712-221600_docs-compression-layer-design.md`](../active-designing/20260712-221600_docs-compression-layer-design.md). Homes: `docs/` shelf (new) compresses raw `active-designing/` + counsel + bron; nothing yondered. Silo relaxation scoped to `docs/` + explicit Dependencies sections; gratitude lines stay. Cross-cutting: depth grades · no load-bearing pins · lint fifth duty (docs-pin match). Proposed lint: `tools/living_docs_lint.rish` (name awaits word). SLC order: PROVEN_SEAT → ENCLOSURE → small three.
