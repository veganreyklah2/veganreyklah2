...
*A living snapshot of what has landed, what is closed, and what remains open. Updated at `164012`: pass 9972 `findLastLinear`; corpus 31.*
...
- **Strengthening pass 9972 (`164012`).** `std.mem.findLastLinear` postcondition; corpus 31/31 GREEN.
...
- **Strengthening 9994–9972** — through `findLastLinear`. Corpus 31.
...
|----------|--------|--------|
| 1 | **Strengthening series** — next `std` surface through gate trio (9971 and below) | `10023` Track B, `998` |
...
- **Corpus:** 31 programs, all GREEN (9972 `findLastLinear` latest).
