...
**Status:** Landed — laps 1–3 + Kumara vessel stamp; forge view folds a live pour; module home `amphora/`
...
**Forge surface:** Realidream `forgeviewtest` pours `amphora_lap3_tree` via `tools/fixtures/forge_view_pour.sh`, then folds the bundle onto Skate (`tools/realidream_forge_view.rish`).
...
**Witnesses:** `tools/amphora_lap1.rish` · `tools/amphora_lap2.rish` · `tools/amphora_lap3.rish` · `tools/amphora_device_wire.rish` · `tools/amphora_vessel_stamp.rish` · `tools/realidream_forge_view.rish` · elder path `tools/crossing_manifest_seed.rish`
