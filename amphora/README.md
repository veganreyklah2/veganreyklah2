...
**Status:** Landed — laps 1–3 + Kumara stamp + Amber AEAD seal; forge view folds a live sealed pour; module home `amphora/`
...
**Witnesses:** `tools/amphora_lap1.rish` · `tools/amphora_lap2.rish` · `tools/amphora_lap3.rish` · `tools/amphora_device_wire.rish` · `tools/amphora_vessel_stamp.rish` · `tools/amphora_vessel_seal.rish` · `tools/realidream_forge_view.rish` · elder path `tools/crossing_manifest_seed.rish`
