...
| **Purchase delivery (landed)** | Commerce slip binds `vessel_parent` + `payment` under Kumara; Granary lap 1 seated (sharing surface); Mandi parks for vessel market floor |
