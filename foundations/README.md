...
- `20260706-022912_the-wire-serves-the-fold.md` — carriage first-principles for Comlink: the record is sovereign and the wire serves it; one logic and many wires; identity is the address; a fact arrives whole or not at all; reliability is transactional and waits its lap; everything is bounded; siloed from [`../external-research/20260706-022912_ames-vere-libuv-content-carriage.md`](../external-research/20260706-022912_ames-vere-libuv-content-carriage.md); enters canon on Kaeden's word.
