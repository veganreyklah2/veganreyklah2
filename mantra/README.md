...
The module grew as one foundation and a family of compositions. `recall_lap1.rye` holds the catalog and its laws; every file after it **imports that foundation and edits nothing beneath itself** — the pattern held across the entire arc, parity 159 through 175.
