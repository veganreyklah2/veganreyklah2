...
**Language:** EN
**Last updated:** 2026-07-10 (corpus rish view `185542`; parity **269**)
...
| **rish view** | `kind rish` → five-line Skate frame | parity **269** · `tools/inference_anvil_corpus_rish_view.rish` (`185542`) |
