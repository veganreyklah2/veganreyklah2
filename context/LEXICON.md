...
| **Tablecloth query** | Optional-field filter over the bounded namespace catalog — every match in held order; parity **175**; hosted Comlink wire **219**; device virtio **246**; query device view **247**; unified view **248**; forge device/unified **249**/**250**; assist lap 2 **251** (`180111`); not the Brix artifact store (counsel `20260707.005612`) |
...
| **Lantern** | Named (`2026-07-10`) — bounded inference request/response; lap 0 fixture + lap 1 `max_tokens` truncate at `lantern/` — [`../lantern/README.md`](../lantern/README.md) |
