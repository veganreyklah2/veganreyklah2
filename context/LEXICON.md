...
| **Lantern** | Named (`2026-07-10`) — bounded inference request/response; pins through tokens_out · tokens_in · echo · user at `lantern/` (parity through **410**) — [`../lantern/README.md`](../lantern/README.md) |
