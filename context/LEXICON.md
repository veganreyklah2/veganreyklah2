...
| **Lantern** | Named (`2026-07-10`) — bounded inference request/response; pins through tokens_out · tokens_in · echo · user at `lantern/`; echo · user also on assist/sight glass (parity through **418**); **RW-5** Drawn Terminal ↔ Lantern mirrored pair at tips **420**/**421** — [`../lantern/README.md`](../lantern/README.md) |
