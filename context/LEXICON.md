...
| **Tablecloth query** | Optional-field filter over the bounded namespace catalog — every match in held order; parity **175**; hosted Comlink wire **219**; device virtio **246** (`174217`); not the Brix artifact store (counsel `20260707.005612`) |
