...
| **Lattice** | Named (`2026-07-10`) — f32 tensors in bounded gardens; matmul · add · reshape · reduce_sum · scale · transpose · mul · fill · copy · sub · neg · div · reduce_mean · abs · clamp · reduce_max · reduce_min · sqrt · exp · log · pow · relu · sigmoid · softmax · tanh · gelu · silu · leaky_relu · softplus · maximum · minimum · elu · softsign · square · sign · reciprocal at `lattice/` (parity through **401**) — [`../lattice/README.md`](../lattice/README.md) · [`../active-designing/20260710-133500_inference-stack-lap0-hammock.md`](../active-designing/20260710-133500_inference-stack-lap0-hammock.md) |
| **Scribble** | Named (`2026-07-10`) — markdown → block values; rye/rish/plain extract + headings + paragraphs + fence kinds + outline/paragraphs/fence/plain/rye/rish/h1/h2/h3/depth-tally/tally/blocks/fence+heading/tally+blocks/para+blocks/h1+blocks/h2+blocks/h3+blocks views + heading depth filter at `scribble/` (parity through **400**) — [`../scribble/README.md`](../scribble/README.md) |
| **Lantern** | Named (`2026-07-10`) — bounded inference request/response; fixture · `max_tokens` · allow-list · temperature/seed · top_p · err_stop · stop_sequence · prompt pin · max_tokens pin · text pin · temperature pin · seed pin · TopPMismatch · err_stop pin · length_stop pin · empty allow-list · allow_count · dual-model · require_model · stopped_reason pin · stream pin · top_k · frequency_penalty · presence_penalty · n · tokens_out · tokens_in at `lantern/` (parity through **402**) — [`../lantern/README.md`](../lantern/README.md) |
