...
| **Greencandy** | Named (`2026-07-10`) — centralized books of record at `greencandy/`: chart, journal, fold, P&L/BS, exception queue, Skate books · exception · P&L · BS · TB · journal · chart · sight-with-chart · sight-with-P&L views; complements MALA — [`active-designing/20260710-125953_greencandy-hammock.md`](../active-designing/20260710-125953_greencandy-hammock.md) · [`../greencandy/README.md`](../greencandy/README.md) |
| **Lattice** | Named (`2026-07-10`) — f32 tensors in bounded gardens; matmul · add · reshape · reduce_sum · scale · transpose · mul · fill · copy · sub · neg · div · reduce_mean · abs · clamp · reduce_max · reduce_min · sqrt · exp · log · pow · relu · sigmoid · softmax · tanh · gelu at `lattice/` (parity **211**/**217**/**257**/**260**/**264**/**268**/**272**/**276**/**280**/**284**/**291**/**295**/**299**/**303**/**307**/**311**/**315**/**319**/**323**/**327**/**331**/**335**/**339**/**343**/**347**/**351**) — [`../lattice/README.md`](../lattice/README.md) · [`../active-designing/20260710-133500_inference-stack-lap0-hammock.md`](../active-designing/20260710-133500_inference-stack-lap0-hammock.md) |
| **Scribble** | Named (`2026-07-10`) — markdown → block values; rye/rish/plain extract + headings + paragraphs + fence kinds + outline/paragraphs/fence/plain/rye/rish/h1/h2/h3/depth-tally/tally/blocks/fence+heading views + heading depth filter at `scribble/` (parity **218**/**253**/**261**/**262**/**270**/**273**/**278**/**282**/**286**/**296**/**300**/**308**/**312**/**316**/**324**/**332**/**340**/**348**) — [`../scribble/README.md`](../scribble/README.md) |
| **Lantern** | Named (`2026-07-10`) — bounded inference request/response; fixture · `max_tokens` · allow-list · temperature/seed · top_p · err_stop · stop_sequence · prompt pin · max_tokens pin · text pin · temperature pin · seed pin · TopPMismatch · err_stop pin · length_stop pin · empty allow-list · allow_count · dual-model · require_model · stopped_reason pin · stream pin at `lantern/` (parity **213**/**252**/**258**/**275**/**279**/**283**/**287**/**294**/**298**/**302**/**306**/**310**/**314**/**318**/**322**/**326**/**330**/**334**/**338**/**342**/**346**/**350**/**354**) — [`../lantern/README.md`](../lantern/README.md) |
| **Anvil** | Named (`2026-07-10`) — local forge; corpus catalog + rye/prefix/rish/rye-prefix/tools-prefix/greencandy-prefix/apps-prefix/rye-greencandy/rish-tools/rye-apps Skate views at `anvil/` (parity **214**–**216**/**259**/**265**/**269**/**281**/**293**/**297**/**304**/**317**/**320**/**328**); LoRA horizon — [`../anvil/README.md`](../anvil/README.md) · horizon [`../external-research/20260710-133500_local-forge-minisforum-inference.md`](../external-research/20260710-133500_local-forge-minisforum-inference.md) |
