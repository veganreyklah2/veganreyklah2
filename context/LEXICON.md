...
| **Greencandy** | Named (`2026-07-10`) — centralized books of record at `greencandy/`: chart, journal, fold, P&L/BS, exception queue, Skate books · exception · P&L · BS views; complements MALA — [`active-designing/20260710-125953_greencandy-hammock.md`](../active-designing/20260710-125953_greencandy-hammock.md) · [`../greencandy/README.md`](../greencandy/README.md) |
| **Lattice** | Named (`2026-07-10`) — f32 tensors in bounded gardens; matmul · add · reshape · reduce_sum · scale · transpose · mul at `lattice/` (parity **211**/**217**/**257**/**260**/**264**/**268**/**272**) — [`../lattice/README.md`](../lattice/README.md) · [`../active-designing/20260710-133500_inference-stack-lap0-hammock.md`](../active-designing/20260710-133500_inference-stack-lap0-hammock.md) |
| **Scribble** | Named (`2026-07-10`) — markdown → block values; rye/rish extract + headings + paragraphs + outline/paragraphs views at `scribble/` (parity **218**/**253**/**261**/**262**/**270**/**273**) — [`../scribble/README.md`](../scribble/README.md) |
