...
| **Tablecloth query** | Optional-field filter over the bounded namespace catalog — every match in held order; parity **175**; hosted Comlink wire lap parity **219**; not the Brix artifact store (counsel `20260707.005612`) |
...
| **Mandi** | **Vessel market floor** — where harvests and amphorae change hands, priced in MALA; name seated `20260710.165634`; lap 1 vessel listing (parity **238**); floor view `20260710.170700` (parity **240**); distinct from Granary — [`specs/20260710-165634_mandi-name-seated.md`](specs/20260710-165634_mandi-name-seated.md) · [`../mandi/README.md`](../mandi/README.md) · study [`../external-research/20260703-200712_compute-commerce-on-the-network.md`](../external-research/20260703-200712_compute-commerce-on-the-network.md) |
