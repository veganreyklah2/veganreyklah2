...
| **Consumer edge** | Design-toward shape: a capability-shaped **pass** grants access to a published slice / signed submit; signatures gate **truth**; the sealed datagram keeps carrying the fold — pass = door, record = room; seats after Seam study 1 |
