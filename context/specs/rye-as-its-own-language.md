...
- Rishi can begin: a language of its own deserves a shell of its own. (See [`../active-designing/989_the_faithful_hand.md`](../active-designing/989_the_faithful_hand.md), [`../rishi/README.md`](../rishi/README.md), and [`../active-designing/996_growing_a_language.md`](../active-designing/996_growing_a_language.md).)
