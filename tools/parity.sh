...
corpus="dir_iterate_test.rye fs_boundary_test.rye mem_diff_test.rye sha3_256_test.rye sha3_256_boundary_test.rye sha3_512_test.rye sha3_boundary_test.rye version_test.rye call_paths_test.rye ed25519_sign_test.rye x25519_agree_test.rye aead_seal_test.rye sealed_message_test.rye mantra_weave_test.rye tally_gardens_test.rye alloc_print_test.rye"
